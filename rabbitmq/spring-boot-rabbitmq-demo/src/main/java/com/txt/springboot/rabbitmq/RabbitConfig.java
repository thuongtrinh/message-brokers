package com.txt.springboot.rabbitmq;
...
public class RabbitConfig implements RabbitListenerConfigurer {
    ...
    // send invalid messages to a separate queue use DLQ concept
    ...
    Queue ordersQueue() {
        return QueueBuilder.durable(QUEUE_ORDERS)
                ...
                .withArgument("x-message-ttl", 5000) // If message is not consumed in 5 seconds send to DLQ
                .build();
    }
