...
@EnableJpaRepositories(entityManagerFactoryRef = "entityManagerFactory", basePackages = {"com.txt.eda.engine.repositories"})
@EntityScan(basePackages = {"com.txt.eda.engine"}, basePackageClasses = {Jsr310JpaConverters.class})
public class PostgresDBConfig {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory(EntityManagerFactoryBuilder builder,
        ...
        localContainerEntityManagerFactoryBean.setPackagesToScan("com.txt.eda.engine");
