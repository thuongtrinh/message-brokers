...
@Slf4j
public class InitialProcessDataService {
    ...
    public void execute(DelegateExecution execution) {
        ...
        setProcessConfigData(execution, transactionConfig);
    }
    ...
    private void setProcessConfigData(DelegateExecution execution, TransactionConfig transactionConfig) {
//        execution.getParent().setVariable("authorityResult", "PASS");
        execution.getParent().setVariable(CONTITION_IS_SKIP_FCHECK, transactionConfig.getIsSkipFCheck());
    }
