...
@EnableJpaRepositories(entityManagerFactoryRef = "entityManagerFactory", basePackages = {"com.txt.eda.rest.repositories.postgres"})
@EntityScan(basePackages = {"com.txt.eda.rest.entities.postgres"}, basePackageClasses = {Jsr310JpaConverters.class})
...
//    @PersistenceContext(unitName = "ecustomerUnit")
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory(EntityManagerFactoryBuilder builder,
        ...
        localContainerEntityManagerFactoryBean.setPackagesToScan("com.txt.eda.rest.entities.postgres");
